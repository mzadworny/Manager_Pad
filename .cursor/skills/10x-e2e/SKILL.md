...
State _why_ the phase isn't a browser-level fit (one or two sentences, grounded in the table above), then Ask the user: "Phase [N] isn't a good E2E fit. How do you want to handle it?"
